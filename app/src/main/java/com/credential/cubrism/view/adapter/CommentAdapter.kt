...
class ChattingAdapter(private val items: ArrayList<Chat>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    inner class MyViewHolder(v: View) : RecyclerView.ViewHolder(v) {
        val chat = v.findViewById<TextView>(R.id.txtMessage)
        val myreplyimg = v.findViewById<ImageView>(R.id.imgReply)
        val myreplynick = v.findViewById<TextView>(R.id.txtReply)
    }
    inner class YourViewHolder(v: View) : RecyclerView.ViewHolder(v) {
        val chat = v.findViewById<TextView>(R.id.txtMessage)
        val yourreplybtn = v.findViewById<ImageView>(R.id.imgReplyTo)
        val yourreplyimg = v.findViewById<ImageView>(R.id.imgReply)
        val yourreplynick = v.findViewById<TextView>(R.id.txtNickname)
    }
